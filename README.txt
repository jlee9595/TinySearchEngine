...
The assumptions that my crawler program make are that the directory that it writes files to is empty prior to calling it and the target directory ends in a "/"
